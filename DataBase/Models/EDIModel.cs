...
namespace Database.Models
{
    ...
    public class Transaction {
        ...
        [Required(ErrorMessage = "receiver is required in transaction")]
        [XmlElement("receiver")]
    ...
    public class Claims
    {
        ...
        public ReferingProvider[] ReferingProvider { get {
        ...
        public OtherSubscriberDetails[] otherSubscriberDetails { get {
        ...
        public ServiceLine[] ServiceLine { get {
                if (serviceline == null) {
    ...
    public class OtherSubscriberDetails {
        ...
        [XmlElement("referingprovider")]
        public OtherPayerReferingProvider[] otherPayerReferingProvider { get {
    ...
    public class ServiceLine
    {
        ...
        [XmlElement("referingprovider")]
        public ServiceLineReferingProvider[] referingProvider { get {
        ...
        public FormIdentificationCode[] formIdentificationCode { get {
    ...
    public class BillingProviderDetails
    {
        [XmlElement("NM1")]
        public NM1 NM1 { get; set; } = new NM1();
        [Required(ErrorMessage = "N3 value is required")]
        [XmlElement("N3")]
        public N3 N3 { get; set; } = new N3();
        [XmlElement("N4")]
        public N4 N4 { get; set; } = new N4();
