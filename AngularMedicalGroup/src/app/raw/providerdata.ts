...
export const PrimarySpeciality=[{abbrevation:'A'  ,name:'Allergy'                                         },
...
export const ProviderAddressCountry=[
...
export const ProviderProfSuffix=[
    'ACNP',
    'CNM',
    'CRNA',
    'CRNP',
...
export const ProviderSuffix=['II',
'III',
'IV',
'JR.',
'SR.',
...
export const ProviderGender=[
    'Male',
    'Female',
    'Not Applicable'
]
export const ProviderCitizenship=[
    'NOT APPLICABLE',
    'UNKNOWN',
    'YES',
    'NO'
]
export const ProviderContractType=['CONTRACT - NOTCREDENTIALED','CONTRACT NO REFERAL','CONTRACTED','CONTRACTED-CAPITATED','LETTER OF AGREEMENT','MOU AGREMENT ONLY','NON CONTRACTED','OTHER','PT SPECIFIC LOA']
export const CarrierLocality=[
...
export const ProviderAccount=['0000-000 DEFAULT',
'5700-000 CONTRACT PROVIDER',
'5800-000 NO CONTRACT PROVIDER',
'5800-600 MOU // ONE TIME AGREEMENTI',
'5900-000 MOU AGREEMENT ONLY']
export const ProviderPaymentType=['CAPITATED','FEE FOR SERVICE','MOU ONLY','OTHER', 'PARTIALLY CAP'];
export const ProviderOrganizationType=['ADDISTIONAL VENDOR TEST','PRIMARY','SECONDARY','THIRD','VENDHIST'];
export const ProviderLetterMode=['EMAIL','FAX','BATCH PRINT','NONE'];
export const ProviderPracticeType=['BILL - BILLING OFFICE',
'BUS - BUSINESS OFFICE',
...
'UNKNOWN - UNKNOWN'];
export const ProviderContractTemplate=['100 MEDICARE MEDICAL RIVERSIDE [ 2018/01/01 ]',
