...
namespace Angular_API.Controllers
{
    ...
    public class UsersController : ApiController
    {
        ...
        {
            await _db.UpdatePCPs(memberid, healthplan, pcps);
            return Ok(pcps);
        }
        [HttpPost]
        [Route("postHPs")]
        public async Task<IHttpActionResult> SaveAllHps([FromUri]String memberid, [FromUri]String healthplan, [FromBody]MemberHealthPlanModel[] hps)
        {
            await _db.UpdateHPs(memberid,healthplan,hps);
            return Ok(hps);
        }
        [HttpPost]
        [Route("searchMember")]
        ...
        public async Task<IHttpActionResult> GetMember(string memberid, string healthplan) {
            List<MembersModel> members = await _db.selectMember(memberid,healthplan);
            return Ok(members);
        }
        [HttpGet]
        [Route("getPCPs")]
        public async Task<IHttpActionResult> GetAllPCPs(String memberid, String healthplan)
        {
            MemberPCPModel[] data = await _db.GetMemberPcps(memberid, healthplan);
            return Ok(data);
        }
        [HttpGet]
        [Route("getHealthPlans")]
        public async Task<IHttpActionResult> GetAllHps(String memberid, String healthplan) {
